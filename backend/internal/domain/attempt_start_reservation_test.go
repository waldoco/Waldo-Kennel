...
func TestAttemptStartReservationRequiresAttributedTypedEvidence(t *testing.T) {
	...
	r := AttemptStartReservation{ID: "res", AttemptID: "att", OutcomeID: "out", PlanRevisionID: "plan", WorkUnitID: "wu", ContractRevisionNumber: 1, RunIntentGeneration: 2, RequestKey: "key", RequestFingerprint: "", RoutingSnapshotID: "snap", RoutingGenerationID: "gen", AdmissionEvaluationID: "eval", RefusalStatus: AttemptStartRefusalOpen, Denial: d, CreatedAt: time.Now()}
